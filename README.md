...
docker run --name api-test-container -e SUITE_NAME=api -d test-runner
```
...
Feel free to support the development with a [**donation
**](https://www.paypal.com/donate/?hosted_button_id=MNHYYCYHAKUVA) for the next improvements.
